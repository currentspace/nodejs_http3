//! Test that replicates quiche's http3-server example logic
//! to verify curl interop works with our quiche version.
...
/// It verifies the same transport logic exercised by curl interop.
#[test]
